...
abstract class TestCase extends BaseTestCase
{
	...
	protected function pdo(): PDO
	{
		...
		try {
			...
			// Integration-Tests brauchen eine echte MariaDB (Schema ist
			// MariaDB-spezifisch). Statt der nackten PDOException einen
			// umsetzbaren Hinweis geben, wie man die Test-DB hochfaehrt.
			throw new \RuntimeException(
				"Keine Test-DB-Verbindung ({$dsn}).\n"
				. "Integration-Tests brauchen eine laufende MariaDB. Starte sie mit:\n"
				. "    composer test:integration        (faehrt DB hoch + laeuft die Suite)\n"
				. "oder manuell:\n"
				. "    bash bin/test-db-up.sh && source /tmp/mailpilot-test-db.env\n"
