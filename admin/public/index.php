...
$routes = [
	...
	['POST', '#^/admin/llm/suggestions/(?P<id>[^/]+)/approve$#', LlmController::class, 'approveSuggestion'],
	['POST', '#^/admin/llm/suggestions/(?P<id>[^/]+)/reject$#',  LlmController::class, 'rejectSuggestion'],
